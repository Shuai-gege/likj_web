  ...
  <div class="worker">
    ...
    <div class="no_yuncang">
      ...
      <div class="items flex_l">
        ...
        <div class="item flex" @click="toOrder(3)" v-if="initdata.cloud_model!=2" v-show="show">
        ...
        <div class="item flex" @click="zhuandan" v-if="initdata.take_type!=2" v-show="show">
        ...
        <div class="item flex" @click="xiajidingdan" v-if="initdata.take_type!=2" v-show="show">
